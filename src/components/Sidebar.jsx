      ...
      >
        <ul className="space-y-1.5">
          <li className="hs-accordion" id="users-accordion">
            <a
              className="flex items-center gap-x-3.5 py-2 px-2.5 bg-black cursor-pointer text-white text-sm rounded-lg hover:bg-black hover:text-white dark:bg-gray-900 font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              onClick={() => navigate("/")}
            >
              <svg
                className="size-4"
